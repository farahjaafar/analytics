        ...
        <div className="relative z-10 flex flex-col items-center gap-6 pt-8 md:pt-16 text-center lg:gap-12">
          ...
          >
            <Button size="lg" asChild className={cn(
                                    ...
                                    )}><a href={primaryCta.href}>{primaryCta.text}</a></Button>

            <Button size="lg" variant="ghost" asChild className={cn(
                                      "text-foreground/80 dark:text-foreground/70",
                                      "transition-all duration-300",
                                    )}><a href={secondaryCta.href}>{secondaryCta.icon}{secondaryCta.text}</a></Button>
          </div>
